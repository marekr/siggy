...
siggy2.Activity.Search = function(core)
{
	var $this = this;
	this.key = 'search';
	this.core = core;
...
siggy2.Activity.Search.prototype.search = function()
{
	var $this = this;
	$.ajax({
...
siggy2.Activity.Search.prototype.start = function()
{
	$('#activity-' + this.key).show();
}

siggy2.Activity.Search.prototype.stop = function()
{
