...
use Siggy\LaravelCompat\Componentable;
...
class FormBuilder
{
    ...
    public function old($name)
    {
		...
		//hack to deal with the lack of session
		return $_POST[$this->transformKey($name)] ?? null;
    }
    ...
    {
        if (isset($this->session)) {
            return count($this->session->getOldInput());
        }
