...
(function () {
    ...
    elproto.getBBox = function (isWithoutTransform) {
        ...
        /*Messoroz: IGB HACK*/
				if (this.type == "text") {
            _.bbox = this.node.getBBox();
            _.bbox = {x: _.bbox.x, y: Infinity, width: 0, height: 0};
						for (var i = 0, ii = this.node.getNumberOfChars(); i < ii; i++) {
								var bb = this.node.getExtentOfChar(i);
								(bb.y < _.bbox.y) && (_.bbox.y = bb.y);
								(bb.y + bb.height - _.bbox.y > _.bbox.height) && (_.bbox.height = bb.y + bb.height - _.bbox.y);
								(bb.x + bb.width - _.bbox.x > _.bbox.width) && (_.bbox.width = bb.x + bb.width - _.bbox.x);
						}
