...
class UserInterfaceApi
{
    ...
    public function postUiAutopilotWaypointWithHttpInfo($destination_id, $clear_other_waypoints, $add_to_beginning, $datasource = null)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 403:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\ESI\Model\PostUiAutopilotWaypointForbidden', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 500:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\ESI\Model\PostUiAutopilotWaypointInternalServerError', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
    ...
    public function postUiOpenwindowContractWithHttpInfo($contract_id, $datasource = null)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 403:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\ESI\Model\PostUiOpenwindowContractForbidden', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 500:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\ESI\Model\PostUiOpenwindowContractInternalServerError', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
    ...
    public function postUiOpenwindowInformationWithHttpInfo($target_id, $datasource = null)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 403:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\ESI\Model\PostUiOpenwindowInformationForbidden', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 500:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\ESI\Model\PostUiOpenwindowInformationInternalServerError', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
    ...
    public function postUiOpenwindowMarketdetailsWithHttpInfo($type_id, $datasource = null)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 403:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\ESI\Model\PostUiOpenwindowMarketdetailsForbidden', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 500:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\ESI\Model\PostUiOpenwindowMarketdetailsInternalServerError', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
    ...
    public function postUiOpenwindowNewmailWithHttpInfo($new_mail, $datasource = null)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 403:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\ESI\Model\PostUiOpenwindowNewmailForbidden', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 422:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\ESI\Model\PostUiOpenwindowNewmailUnprocessableEntity', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 500:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\ESI\Model\PostUiOpenwindowNewmailInternalServerError', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
