...
class KillmailsApi
{
    ...
    public function getCharactersCharacterIdKillmailsRecentWithHttpInfo($character_id, $max_count = null, $max_kill_id = null, $datasource = null)
    {
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\ESI\Model\GetCharactersCharacterIdKillmailsRecent200Ok[]', $httpHeader), $statusCode, $httpHeader);
    ...
    public function getKillmailsKillmailIdKillmailHashWithHttpInfo($killmail_id, $killmail_hash, $datasource = null)
    {
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\ESI\Model\GetKillmailsKillmailIdKillmailHashOk', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
