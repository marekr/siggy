...
class BookmarksApi
{
    ...
    public function getCharactersCharacterIdBookmarksWithHttpInfo($characterId, $datasource = null)
    {
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\ESI\Model\GetCharactersCharacterIdBookmarks200Ok[]', $httpHeader), $statusCode, $httpHeader);
    ...
    public function getCharactersCharacterIdBookmarksFoldersWithHttpInfo($characterId, $datasource = null)
    {
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\ESI\Model\GetCharactersCharacterIdBookmarksFolders200Ok[]', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
