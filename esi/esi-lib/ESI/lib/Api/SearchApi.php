...
class SearchApi
{
    ...
    public function getCharactersCharacterIdSearchWithHttpInfo($characterId, $search, $categories, $language = null, $strict = null, $datasource = null)
    {
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\ESI\Model\GetCharactersCharacterIdSearchOk', $httpHeader), $statusCode, $httpHeader);
    ...
    public function getSearchWithHttpInfo($search, $categories, $language = null, $strict = null, $datasource = null)
    {
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\ESI\Model\GetSearchOk', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
