...
final class miscUtils
{
	...
	public static $magsLookup = array( 	1 => array( 
										0 => "",
										...
										205 => "Ruined Angel Template Site",
										...
										225 => "Ruined Blood Raider Template Site",
										...
										245 => "Ruined Guristas Template Site",
										...
										265 => "Ruined Sansha Template Site",
										...
										285 => "Ruined Serpentis Template Site",
	...
	public static $radarsLookup = array( 	1 => array( 
												0 => "",
			...
			foreach($data as $k => $item)
			{
				...
				if( count($matches) == 2 )
				{
					switch( $matches[1] )
					{
						...
						case __('Ore Site'):
							$sigData['type'] = 'grav';
							$sigData['siteID'] = self::siteIDLookupByName( $data[$k+1], 'grav' );
							break;
						case __('Combat Site'):
							$sigData['type'] = 'combat';
