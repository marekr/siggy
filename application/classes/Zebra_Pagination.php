...
class Zebra_Pagination
{
    ...
    function render($return_output = false)
    {
        ...
        $output = '<div class="pagination pagination-small pagination-centered pagination-inverse">';
        $output .= '<ul>';
        ...
        if ($this->_total_pages > $this->_selectable_pages) {
            ...
            $output .= '<li' .($this->page == 1 ? ' class="disabled"' : '') . '><a href="' .
        ...
        if ($this->_total_pages <= $this->_selectable_pages) {
            ...
            for ($i = 1; $i <= $this->_total_pages; $i++) {
                ...
                $output .= '<li'.
                    ...
                    ($this->page == $i ? ' class="active"' : '').'><a href="' . $this->_build_uri($i) . '">' . $i .
                    '</a></li>';
        ...
        // if the total number of pages is greater than the number of selectable pages
            ...
            $output .= '<li'.
                ...
                ($this->page == 1 ? ' class="active"' : '').'><a href="' . $this->_build_uri(1) . '">1' .
            ...
            for ($i = $starting_page; $i <= $ending_page; $i++) {
                ...
                $output .= '<li'.($this->page == $i ? ' class="active"' : '').'><a href="' . $this->_build_uri($i) . '">' . $i .
           ...
           // if ($this->_total_pages - $ending_page > 1) $output .= '<span>&hellip;</span>';
            ...
            if ($this->_total_pages > $this->_selectable_pages) {
                ...
                $output .= '<li' . ($this->page == $this->_total_pages ? ' class="disabled"' : '').'><a href="' .
