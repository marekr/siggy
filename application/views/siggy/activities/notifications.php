<div id="activity-notifications" class="wrapper" style="display:none">
	...
	<div class='bordered-wrap sub-display-group'>
		<ul class="box-tabs">
				...
				<p>
					<div class="dropdown">
						...
						<ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
							...
							<li role="presentation"><a role="menuitem" id='notifier_add_system_resident_found'tabindex="-1" href="#">Resident found</a></li>
