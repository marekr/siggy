...
<html>
  <head>
    <title>siggy</title>
     ...
     <link type="text/css" href="<?php echo URL::base(TRUE, TRUE);?>public/css/siggy.css?23" rel="stylesheet" media="screen" /> 
    ...
    <script type='text/javascript' src='<?php echo URL::base(TRUE, TRUE);?>public/js/siggy.compiled.js?48'></script>
    <?php endif; ?>
  </head>
  <body>
		...
		<div id="floatingHeader">
				...
				<div>
					...
					<?php if( ( count( $group['groups']) > 1  ) || (count( current( $group['groups'] ) ) > 1 ) ):?>							
									<div class='dropDown' id='accessMenu' style='position:absolute;left:83px;top:25px;'>
											<span style="font-size:0.9em;font-style:italic;font-weight: normal;padding:3px 6px;background-color: #092665;"><?php echo $group['accessName']; ?> - <?php echo ($group['subGroupID'] != 0 ) ? $group['sgName'].' - ' : '' ?><?php echo $group['groupTicker'] ?>&nbsp;&nbsp;&nbsp;<span style='font-style:normal;font-weight:bold;'>V</span></span>
											<ul class='menu'>
			...
			<div id="globalNotesContainer">
				...
				<div id="globalNotesButton">Show Notes &darr;</div>
			</div>
		</div>
		<br />
		<?php endif; ?>
