...
<div id="chain-map-container" class="bordered-wrap">
		...
		<div id='map-footer-bar'>
			<div style="left: 0;position: absolute;">
				...
				<a data-navigo href='chainmap' class="btn btn-default btn-xs btn-info"><i class="fa fa-table"></i></a>
				<!--- end options -->
			</div>
			<div style="right: 0;position: absolute;">
				<!--- broadcast -->
				@if( !$group->always_broadcast)
				<button id="chainmap-broadcast-button" class="btn btn-default btn-xs">
				<i class="fa fa-wifi"></i>
					@if( isset($_COOKIE['broadcast']) && $_COOKIE['broadcast'] == 0 ) 
						Enable location broadcast
					@else
						Disable location broadcast
					@endif
				</button>
				@endif
			</div>
...
<!--- end chain map -->
@include('siggy.handlebars.map_system_blob')